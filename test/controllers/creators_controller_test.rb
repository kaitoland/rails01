...
class CreatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creator" do
    assert_difference('Creator.count') do
      post creators_url, params: { creator: { name: @creator.name, type: @creator.type, url: @creator.url } }
    end
  ...
  test "should update creator" do
    patch creator_url(@creator), params: { creator: { name: @creator.name, type: @creator.type, url: @creator.url } }
